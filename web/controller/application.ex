...
defmodule StackoverflowCloneE.Controller.Application do
  defmacro __using__(_) do
    quote do
      use Antikythera.Controller

      alias Antikythera.{Conn, Request}
      alias StackoverflowCloneE.DodaiId
      alias StackoverflowCloneE.Helper.ErrorJson
      ...
      defun validate_params(conn :: v[Conn.t], v :: Dict.t, validator :: module | fun, f :: ((Conn.t, any) -> any)) :: any do
        case validate_imp(validator, v) do
          ...
          {:error, _}      -> ErrorJson.json_by_error(conn, StackoverflowCloneE.Error.BadRequestError.new())
        end
      end
    end
  end
