...
defmodule StackoverflowCloneE.Controller.Book.IndexRequestParams do
...
defmodule StackoverflowCloneE.Controller.Book.Index do
  ...
  alias StackoverflowCloneE.Controller.Book.{Helper, IndexRequestParams}
