defmodule StackoverflowCloneE.Controller.Book.IndexTest do
  use StackoverflowCloneE.CommonCase
  alias Dodai.RetrieveDedicatedDataEntityListRequestQuery, as: Query
  alias Sazabi.G2gClient
  alias StackoverflowCloneE.Controller.Book.Index
  alias StackoverflowCloneE.Controller.Book.IndexRequestParams
  alias StackoverflowCloneE.TestData.BookData
